package gg.sulfur.client.impl.gui.alt.boom;

import java.io.IOException;

import gg.sulfur.client.Sulfur;
import gg.sulfur.client.impl.gui.alt.GUIAltManager;
import gg.sulfur.client.impl.utils.AltUtils;
import net.minecraft.util.ResourceLocation;
import org.lwjgl.input.Keyboard;
import org.lwjgl.input.Mouse;
import org.lwjgl.opengl.GL11;
import gg.sulfur.client.impl.gui.alt.boom.Alt;
...
extends GuiScreen {
    ...
    private ResourceLocation background = new ResourceLocation("meme/altman.png");
   ...
   // private TheAlteningAuthentication serviceSwitcher = TheAlteningAuthentication.mojang();
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 2: {
                ...
                AltManager altManager = Sulfur.getInstance().altManager;
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        Gui.drawRect(50.0f, 33.0f, width - 50, height - 50, -2142943931);
        GL11.glPushMatrix();
        this.prepareScissorBox(0.0f, 33.0f, width, height - 50);
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = Sulfur.getInstance().altManager;
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(7, width - 100, 0, 100, 20, "Generate Cracked"));
    //    this.buttonList.add(new GuiButton(8, width - 200, 0, 100, 20, "Generate Cracked"));
        this.login.enabled = false;
        this.remove.enabled = false;
        this.rename.enabled = false;
    }
