...
public class BlurUtil {
    ...
    public static void init() {
        try {
            shaderGroup = new ShaderGroup(mc.getTextureManager(), mc.getResourceManager(), mc.getFramebuffer(), new ResourceLocation("blur.json"));
    ...
    public static void blur(double x, double y, double areaWidth, double areaHeight, int blurStrength) {
        ...
        RenderUtils.drawRoundedRect(x, y, areaWidth, areaHeight, 1, new Color(255, 255, 255, 0).getRGB());
        Stencil.erase(true);
        GlStateManager.enableBlend();
        blur(blurStrength);
        Stencil.dispose();
