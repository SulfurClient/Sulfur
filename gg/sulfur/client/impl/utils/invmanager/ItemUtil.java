package gg.sulfur.client.impl.utils.invmanager;
...
public class ItemUtil {
    ...
    public static float getSharpnessLevel(ItemStack stack) {
        ...
        return (float) EnchantmentHelper.getEnchantmentLevel(Enchantment.field_180314_l.effectId, stack) * 1f;
    }
    ...
    public static float getItemDamage(ItemStack itemStack) {
        ...
        double damage = 4.0 + ((ItemSword) itemStack.getItem()).func_150931_i();
        damage += EnchantmentHelper.getEnchantmentLevel(Enchantment.field_180314_l.effectId, itemStack) * 1.25;
        return (float) damage;
    }
    ...
    public static double getArmorProtection(ItemStack armorStack) {
        ...
        double protectionLevel = EnchantmentHelper.getEnchantmentLevel(Enchantment.field_180310_c.effectId, armorStack);
