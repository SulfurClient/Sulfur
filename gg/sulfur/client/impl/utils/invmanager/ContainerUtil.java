...
public class ContainerUtil {
    ...
    public static float getSharpnessLevel(ItemStack stack) {
        ...
        return (float) EnchantmentHelper.getEnchantmentLevel(Enchantment.field_180314_l.effectId, stack) * 1.25f;
    }
    ...
    public static double getArmorProtection(ItemStack armorStack) {
        ...
        final double protectionLevel = EnchantmentHelper.getEnchantmentLevel(Enchantment.field_180310_c.effectId, armorStack);
