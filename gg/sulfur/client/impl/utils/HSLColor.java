...
/**
 * The ColorUtil class provides methods to manipulate HSL (Hue, Saturation
...
public class HSLColor {
    ...
    /**
     * Create a ColorUtil object using an RGB Color object.
     *
     * @param rgb
    ...
    /**
     * Create a ColorUtil object using individual HSL values and a default alpha
     * value of 1.0.
     *
     * @param h
    ...
    /**
     * Create a ColorUtil object using individual HSL values.
     *
     * @param h
    ...
    /**
     * Create a ColorUtil object using an an array containing the individual HSL
    ...
    /**
     * Create a RGB Color object based on this ColorUtil with a different Hue
    ...
    /**
     * Create a RGB Color object based on this ColorUtil with a different
    ...
    /**
     * Create a RGB Color object based on this ColorUtil with a different Shade.
    ...
    /**
     * Create a RGB Color object based on this ColorUtil with a different Tone.
     ...
     * ColorUtil. This is a convenience method. The complementary color is
    ...
    public String toString() {
        String toString = "ColorUtil[h=" + hsl[0] + ",s=" + hsl[1] + ",l="
                + hsl[2] + ",alpha=" + alpha + "]";
