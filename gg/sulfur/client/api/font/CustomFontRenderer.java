...
public final class CustomFontRenderer {
    ...
    public CustomFontRenderer(final Font font, final int characterCount) {
        this(font, characterCount, true);
    }

    public CustomFontRenderer(final Font font, final int characterCount, final boolean antiAlias) {
        this.font = font;
    ...
    public void drawCenteredStringWithShadow(final String text, final float x, final float y2, final int color) {
        final float width = getWidth(text) / 2.0f;
    ...
    private void renderString(final String text, float x, float y2, final int color, final boolean shadow) {
        ...
        for (int i = 0; i < length; ++i) {
            ...
            drawChar(character, characterData, x, y2);
