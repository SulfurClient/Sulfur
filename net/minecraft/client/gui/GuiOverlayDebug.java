...
public class GuiOverlayDebug extends Gui {
    ...
    protected List call() {
        ...
        if (this.func_175236_d()) {
            return Lists.newArrayList("Sulfur (" + this.mc.func_175600_c() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", Integer.valueOf(var1.getX() & 15), Integer.valueOf(var1.getY() & 15), Integer.valueOf(var1.getZ() & 15)));
        } else {
            ...
            ArrayList var5 = Lists.newArrayList("Sulfur (" + this.mc.func_175600_c() + "/" + ClientBrandRetriever.getClientModName() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("XYZ: %.3f / %.5f / %.3f", Double.valueOf(this.mc.getRenderViewEntity().posX), Double.valueOf(this.mc.getRenderViewEntity().getEntityBoundingBox().minY), Double.valueOf(this.mc.getRenderViewEntity().posZ)), String.format("Block: %d %d %d", Integer.valueOf(var1.getX()), Integer.valueOf(var1.getY()), Integer.valueOf(var1.getZ())), String.format("Chunk: %d %d %d in %d %d %d", Integer.valueOf(var1.getX() & 15), Integer.valueOf(var1.getY() & 15), Integer.valueOf(var1.getZ() & 15), Integer.valueOf(var1.getX() >> 4), Integer.valueOf(var1.getY() >> 4), Integer.valueOf(var1.getZ() >> 4)), String.format("Facing: %s (%s) (%.1f / %.1f)", var3, var4, Float.valueOf(MathHelper.wrapAngleTo180_float(var2.rotationYaw)), Float.valueOf(MathHelper.wrapAngleTo180_float(var2.rotationPitch))));
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.isBlockLoaded(var1)) {
                ...
                var5.add(String.format("Local Difficulty: %.2f (Day %d)", Float.valueOf(var7.func_180168_b()), Long.valueOf(this.mc.theWorld.getWorldTime() / 24000L)));
            }
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.func_178782_a() != null) {
                ...
                var5.add(String.format("Looking at: %d %d %d", Integer.valueOf(var91.getX()), Integer.valueOf(var91.getY()), Integer.valueOf(var91.getZ())));
            }
    ...
    protected List func_175238_c() {
        ...
        long var7 = var3 - var5;
        ArrayList var9 = Lists.newArrayList(String.format("Java: %s %dbit", System.getProperty("java.version"), this.mc.isJava64bit() ? 64 : 32), String.format("Mem: % 2d%% %03d/%03dMB", var7 * 100L / var1, func_175240_a(var7), func_175240_a(var1)),
                String.format("Allocated: % 2d%% %03dMB", var3 * 100L / var1, func_175240_a(var3)), "",
                String.format("Display: %dx%d (%s)", Display.getWidth(), Display.getHeight(),
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists()) {
            ...
            var9.add("");
            var9.addAll((Collection) Reflector.call(var10, Reflector.FMLCommonHandler_getBrandings, new Object[]{false}));
        }
