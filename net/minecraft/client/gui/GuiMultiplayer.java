...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
     ...
     */
    public void initGui() {
//        Display.setTitle("Dortware - Server List");
        ...
        if (!this.initialized) {
            ...
            this.serverListSelector = new ServerSelectionList(this, this.mc, this.width, this.height, 5, this.height - 64, 36);
    ...
    public void createButtons() {
        this.buttonList.add(this.btnEditServer = new GuiButton(7, this.width / 2F - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit")));
        this.buttonList.add(this.btnDeleteServer = new GuiButton(2, this.width / 2F - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete")));
        this.buttonList.add(this.btnSelectServer = new GuiButton(1, this.width / 2F - 154, this.height - 52, 100, 20, I18n.format("selectServer.select")));
        this.buttonList.add(new GuiButton(4, this.width / 2F - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct")));
        this.buttonList.add(new GuiButton(3, this.width / 2F + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add")));
        this.buttonList.add(new GuiButton(8, this.width / 2F + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh")));
        this.buttonList.add(new GuiButton(0, this.width / 2F + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel")));
        this.buttonList.add(new GuiButton(420, this.width - (mc.fontRendererObj.getStringWidth("Alt Manager") + 44), 5, 98, 20, "Alt Manager"));
        this.buttonList.add(new GuiButton(69, 5, 5, 90, 20, "ViaVersion"));
        for (GuiButton button : buttonList) {
            if (button.id == 69) {
                if (!Sulfur.getInstance().isViaVersionEnabled()) {
        ...
        if (button.enabled) {
            ...
            switch (button.id) {
                ...
                case 69:
                    ...
                    // No Dort i will handle this
                    /*try {
                        mc.displayGuiScreen((GuiScreen) ReflectUtils.newInstance("viamcp.gui.GuiProtocolSelector", new Class[]{GuiScreen.class}, this));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Gui.drawRect(0, scaledResolution.getScaledHeight(), scaledResolution.getScaledWidth(), scaledResolution.getScaledHeight() - 55, new Color(50, 50, 50).getRGB());
