...
import gg.sulfur.client.impl.gui.alt.LoginThread;
...
public class GuiDisconnected extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 - 100, this.height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT + 100, "Copy Message"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            ...
            case 3:
                ...
                break;
            case 4:
                StringSelection selection = new StringSelection(this.message.getUnformattedText());
