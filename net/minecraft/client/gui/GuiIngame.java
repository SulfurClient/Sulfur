...
public class GuiIngame extends Gui {
    ...
    public void func_175180_a(float p_175180_1_) {
        ...
        if (this.mc.gameSettings.keyBindPlayerList.getIsKeyPressed() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.getPlayerInfoMap().size() > 1 || var161 != null)) {
        ...
        GlStateManager.enableAlpha();
        Sulfur.getInstance().getEventBus().post(new RenderHUDEvent());
    }
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        if (hud.isToggled() && !hud.showScoreboard.getValue())
            return;
        ...
        for (Iterator var22 = var21.iterator(); var22.hasNext(); var6 = Math.max(var6, this.func_175179_f().getStringWidth(var10))) {
            ...
            if (hud.showNumbers.getValue() || hud.scoreboardLocation.getValue() == Hud.ScoreboardLocation.LEFT)
        ...
        for (Object o : var21) {
            Score score = (Score) o;
            ++scoreY;
            ScorePlayerTeam team = var3.getPlayersTeam(score.getPlayerName());
            String formatPlayerName = ScorePlayerTeam.formatPlayerName(team, score.getPlayerName());
            String teamScore = EnumChatFormatting.RED + "" + score.getScorePoints();
            ...
            switch (hud.scoreboardLocation.getValue()) {
                case LEFT: {
                    x = var241;
            ...
            y = var231 - scoreY * this.func_175179_f().FONT_HEIGHT + hud.scoreboardY.getValue().intValue();
            //var19 = p_180475_2_.getScaledWidth() - var241 + 2;


            drawRect(scaleWith - 2, y, x, y + this.func_175179_f().FONT_HEIGHT, 1342177280);
            if (hud.scoreboardLocation.getValue() != Hud.ScoreboardLocation.LEFT) {
                this.func_175179_f().drawString(formatPlayerName, scaleWith, y, 553648127);
                this.func_175179_f().drawString(teamScore, x - this.func_175179_f().getStringWidth(teamScore), y, 553648127);
            } else {
                this.func_175179_f().drawString(formatPlayerName, 5, y, 553648127);
                //this.func_175179_f().drawString(var16, var19 - this.func_175179_f().getStringWidth(var16), var18, 553648127);
            }

            if (scoreY == var21.size()) {
                String var20 = p_180475_1_.getDisplayName();
                drawRect(scaleWith - 2, y - this.func_175179_f().FONT_HEIGHT - 1, x, y - 1, 1610612736);
                drawRect(scaleWith - 2, y - 1, x, y, 1342177280);
                if (hud.scoreboardLocation.getValue() != Hud.ScoreboardLocation.LEFT)
                    this.func_175179_f().drawString(var20, scaleWith + var6 / 2 - this.func_175179_f().getStringWidth(var20) / 2, y - this.func_175179_f().FONT_HEIGHT, 553648127);
                else
                    this.func_175179_f().drawString(var20,  var6 / 2 - this.func_175179_f().getStringWidth(var20) / 2, y - this.func_175179_f().FONT_HEIGHT, 553648127);
            }
        }
    }
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            for (var22 = MathHelper.ceiling_float_int((var14 + var15) / 2.0F) - 1; var22 >= 0; --var22) {
                ...
                if (var2.isPotionActive(Potion.poison)) {
                    var23 += 36;
                } else if (var2.isPotionActive(Potion.wither) && ((Camera) Sulfur.getInstance().getModuleManager().get(Camera.class)).witherHearts.getValue()) {
                    var23 += 72;
                }
            ...
            if (var371 == null) {
                ...
                for (int var39 = 0; var26 > 0; var39 += 20) {
                    ...
                    for (int var30 = 0; var30 < var29; ++var30) {
                        ...
                        this.drawTexturedModalRect(var33, var27, var31, 9, 9, 9);
