                    ...
                    if (var10 != null) {
                        ...
                        if (var11 < 200 || var3) {
                            ...
                            if (var14 > 3) {
                                ...
                                if (!(camera.isToggled() && camera.clearChat.getValue())) {
                                    drawRect(var15, var16 - 9, var15 + var8 + 4, var16, var14 / 2 << 24);
                                }
                                String var17 = var10.getChatComponent().getFormattedText();
                                GlStateManager.enableBlend();
                                final CustomFontRenderer font = Sulfur.getInstance().getFontManager().getFont("Chat").getRenderer();
                                if (camera.isToggled() && camera.smoothChat.getValue())
                                    font.drawStringWithShadow(var17, var15, (float) (var16 - 8) - 1, 16777215 + (var14 << 24));
                                else
                                    this.mc.fontRendererObj.func_175063_a(var17, var15, (float) (var16 - 8), 16777215 + (var14 << 24));
            ...
            if (var6 >= 0 && var7 >= 0) {
                ...
                if (var6 <= MathHelper.floor_float((float) this.getChatWidth() / this.getChatScale()) && var7 < this.mc.fontRendererObj.FONT_HEIGHT * var8 + var8) {
                    ...
                    if (var9 >= 0 && var9 < this.field_146253_i.size()) {
                        ...
                        for (Object o : var10.getChatComponent()) {
                            ...
                            if (var13 instanceof ChatComponentText) {
                                ...
                                if (camera.isToggled() && camera.smoothChat.getValue())
                                    var11 += font.getWidth(GuiUtilRenderComponents.func_178909_a(((ChatComponentText) var13).getChatComponentText_TextValue(), false)) * 2;
                                else
