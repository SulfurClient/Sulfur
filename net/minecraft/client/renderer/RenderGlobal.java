...
import gg.sulfur.client.impl.modules.render.Glow;
...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    protected boolean func_174985_d() {
        return !Config.isFastRender() && !Config.isShaders() && !Config.isAntialiasing() ? this.field_175015_z != null && this.field_174991_A != null && this.mc.thePlayer != null && (this.mc.thePlayer.func_175149_v() && this.mc.gameSettings.field_178883_an.getIsKeyPressed() || Sulfur.getInstance().getModuleManager().isEnabled(Glow.class)) : false;
    }
        ...
        for (int var3 = 0; var3 < 1500; ++var3) {
            ...
            if (var12 < 1.0D && var12 > 0.01D) {
                ...
                for (int var38 = 0; var38 < 4; ++var38) {
                    ...
                    double var53 = var47 * var28 * var30;
            ...
            if (this.func_174985_d()) {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18) {
                    ...
                    if (!forgeEntityPass || Reflector.callBoolean(var19, Reflector.ForgeEntity_shouldRenderInPass, new Object[]{Integer.valueOf(pass)})) {
                        ...
                        if ((var19 != this.mc.getRenderViewEntity() || this.mc.gameSettings.thirdPersonView != 0 || isShaders) && var25) {
                            this.field_175010_j.renderEntitySimple(var19, partialTicks);
                        }
                    }
                }
    ...
    public void func_174976_a(float partialTicks, int pass) {
        ...
        if (this.mc.theWorld.provider.getDimensionId() == 1) {
            ...
            Vec3 var241 = this.theWorld.getSkyColor(this.mc.getRenderViewEntity(), partialTicks);
            var241 = CustomColors.getSkyColor(var241, this.mc.theWorld, this.mc.getRenderViewEntity().posX, this.mc.getRenderViewEntity().posY + 1.0D, this.mc.getRenderViewEntity().posZ);
            ...
            for (var30 = -3; var30 <= 4; ++var30) {
                for (int var31 = -3; var31 <= 4; ++var31) {
                    ...
                    if (var14 > -5.0F) {
                        ...
                        var5.addVertexWithUV((double) (var34), (double) (var14), (double) (var35 + 8.0F), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                        var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14), (double) (var35 + 8.0F), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                        var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14), (double) (var35), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                        var5.addVertexWithUV((double) (var34), (double) (var14), (double) (var35), (double) ((var32) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                    }

                    if (var14 <= 5.0F) {
                        var5.func_178960_a(var18, var19, var20, 0.8F);
                        var5.func_178980_d(0.0F, 1.0F, 0.0F);
                        var5.addVertexWithUV((double) (var34), (double) (var14 + 4.0F - 9.765625E-4F), (double) (var35 + 8.0F), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                        ...
                        var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14 + 4.0F - 9.765625E-4F), (double) (var35), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                        var5.addVertexWithUV((double) (var34), (double) (var14 + 4.0F - 9.765625E-4F), (double) (var35), (double) ((var32) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                    }
                    ...
                    if (var30 > -1) {
                        ...
                        for (var36 = 0; var36 < 8; ++var36) {
                            var5.addVertexWithUV((double) (var34 + (float) var36), (double) (var14), (double) (var35 + 8.0F), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + (float) var36), (double) (var14 + 4.0F), (double) (var35 + 8.0F), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + (float) var36), (double) (var14 + 4.0F), (double) (var35), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + (float) var36), (double) (var14), (double) (var35), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                        }
                    }
                    ...
                    if (var30 <= 1) {
                        ...
                        for (var36 = 0; var36 < 8; ++var36) {
                            var5.addVertexWithUV((double) (var34 + (float) var36 + 1.0F - 9.765625E-4F), (double) (var14), (double) (var35 + 8.0F), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33 + 8.0F) * 0.00390625F + var23));
                            ...
                            var5.addVertexWithUV((double) (var34 + (float) var36 + 1.0F - 9.765625E-4F), (double) (var14 + 4.0F), (double) (var35), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + (float) var36 + 1.0F - 9.765625E-4F), (double) (var14), (double) (var35), (double) ((var32 + (float) var36 + 0.5F) * 0.00390625F + var22), (double) ((var33) * 0.00390625F + var23));
                        }
                    }
                    ...
                    if (var31 > -1) {
                        ...
                        for (var36 = 0; var36 < 8; ++var36) {
                            var5.addVertexWithUV((double) (var34), (double) (var14 + 4.0F), (double) (var35 + (float) var36), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14 + 4.0F), (double) (var35 + (float) var36), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14), (double) (var35 + (float) var36), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34), (double) (var14), (double) (var35 + (float) var36), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                        }
                    }
                    ...
                    if (var31 <= 1) {
                        ...
                        for (var36 = 0; var36 < 8; ++var36) {
                            var5.addVertexWithUV((double) (var34), (double) (var14 + 4.0F), (double) (var35 + (float) var36 + 1.0F - 9.765625E-4F), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                            ...
                            var5.addVertexWithUV((double) (var34 + 8.0F), (double) (var14), (double) (var35 + (float) var36 + 1.0F - 9.765625E-4F), (double) ((var32 + 8.0F) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                            var5.addVertexWithUV((double) (var34), (double) (var14), (double) (var35 + (float) var36 + 1.0F - 9.765625E-4F), (double) ((var32) * 0.00390625F + var22), (double) ((var33 + (float) var36 + 0.5F) * 0.00390625F + var23));
                        }
                    }
        ...
        if (p_180449_1_.posX >= var5.maxX() - var6 || p_180449_1_.posX <= var5.minX() + var6 || p_180449_1_.posZ >= var5.maxZ() - var6 || p_180449_1_.posZ <= var5.minZ() + var6) {
            ...
            if (var10 > var5.maxX() - var6) {
                ...
                for (var29 = var24; var29 < var26; var28 += 0.5F) {
                    ...
                    var4.addVertexWithUV(var5.maxX(), 256.0D, var29, (double) (var20 + var28), (double) (var20));
                    var4.addVertexWithUV(var5.maxX(), 256.0D, var29 + var31, (double) (var20 + var33 + var28), (double) (var20));
            ...
            if (var10 < var5.minX() + var6) {
                ...
                for (var29 = var24; var29 < var26; var28 += 0.5F) {
                    var31 = Math.min(1.0D, var26 - var29);
                    var33 = (float) var31 * 0.5F;
                    var4.addVertexWithUV(var5.minX(), 256.0D, var29, (double) (var20 + var28), (double) (var20));
                    var4.addVertexWithUV(var5.minX(), 256.0D, var29 + var31, (double) (var20 + var33 + var28), (double) (var20));
            ...
            if (var14 > var5.maxZ() - var6) {
                ...
                for (var29 = var24; var29 < var26; var28 += 0.5F) {
                    var31 = Math.min(1.0D, var26 - var29);
                    var33 = (float) var31 * 0.5F;
                    var4.addVertexWithUV(var29, 256.0D, var5.maxZ(), (double) (var20 + var28), (double) (var20));
                    var4.addVertexWithUV(var29 + var31, 256.0D, var5.maxZ(), (double) (var20 + var33 + var28), (double) (var20));
            ...
            if (var14 < var5.minZ() + var6) {
                ...
                for (var29 = var24; var29 < var26; var28 += 0.5F) {
                    var31 = Math.min(1.0D, var26 - var29);
                    var33 = (float) var31 * 0.5F;
                    var4.addVertexWithUV(var29, 256.0D, var5.minZ(), (double) (var20 + var28), (double) (var20));
                    var4.addVertexWithUV(var29 + var31, 256.0D, var5.minZ(), (double) (var20 + var33 + var28), (double) (var20));
