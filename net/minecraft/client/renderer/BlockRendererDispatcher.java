...
import gg.sulfur.client.impl.events.BlockRenderEvent;
...
public class BlockRendererDispatcher implements IResourceManagerReloadListener {
    ...
    public boolean func_175018_a(IBlockState p_175018_1_, BlockPos blockPos, IBlockAccess p_175018_3_, WorldRenderer p_175018_4_) {
        BlockRenderEvent blockRenderEvent = new BlockRenderEvent(blockPos.getX(), blockPos.getY(), blockPos.getZ());
        Sulfur.getInstance().getEventBus().post(blockRenderEvent);
        try {
            ...
            if (var8 == -1)
                ...
                switch (var8) {
                    case 1:
                        if (Config.isShaders()) {
                            SVertexBuilder.pushEntity(p_175018_1_, blockPos, p_175018_3_, p_175018_4_);
                        }

                        boolean var61 = this.fluidRenderer.func_178270_a(p_175018_3_, p_175018_1_, blockPos, p_175018_4_);
                    ...
                    case 3:
                        IBakedModel var71 = this.getModelFromBlockState(p_175018_1_, p_175018_3_, blockPos);

                        if (Config.isShaders()) {
                            SVertexBuilder.pushEntity(p_175018_1_, blockPos, p_175018_3_, p_175018_4_);
                        }

                        boolean flag3 = this.blockModelRenderer.func_178259_a(p_175018_3_, var71, p_175018_1_, blockPos, p_175018_4_);
            ...
            CrashReportCategory.addBlockInfo(var7, blockPos, p_175018_1_.getBlock(), p_175018_1_.getBlock().getMetaFromState(p_175018_1_));
