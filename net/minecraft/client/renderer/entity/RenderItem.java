    ...
    public void renderItemAboveHead(ItemStack stack, int xPosition, int yPosition) {
        if (stack != null) {
            try {
                ...
                CrashReport var5 = CrashReport.makeCrashReport(var7, "Rendering item");
                CrashReportCategory var6 = var5.makeCategory("Item being rendered");
                var6.addCrashSectionCallable("Item Type", () -> {
                    return String.valueOf(stack.getItem());
                });
                var6.addCrashSectionCallable("Item Aux", () -> {
                    return String.valueOf(stack.getMetadata());
                });
                var6.addCrashSectionCallable("Item NBT", () -> {
                    return String.valueOf(stack.getTagCompound());
                });
                var6.addCrashSectionCallable("Item Foil", () -> {
