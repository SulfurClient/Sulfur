...
import gg.sulfur.client.impl.events.EntityRenderEvent;
import gg.sulfur.client.impl.events.RenderPlayerTagEvent;
import gg.sulfur.client.impl.modules.render.HurtColor;
...
public abstract class RendererLivingEntity extends Render {
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[]{p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)})) {
            ...
            boolean doHeadRots = p_76986_1_ instanceof EntityPlayerSP;
            ...
            try {
                ...
                if (doHeadRots) {
                    EntityPlayerSP entityPlayerSP = (EntityPlayerSP) p_76986_1_;
                    var11 = this.interpolateRotation(entityPlayerSP.prevRenderYawHead, entityPlayerSP.renderYawHead, p_76986_9_);
                } else
                    var11 = this.interpolateRotation(p_76986_1_.prevRotationYawHead, p_76986_1_.rotationYawHead, p_76986_9_);
                ...
                if (doHeadRots) {
                    EntityPlayerSP entityPlayerSP = (EntityPlayerSP) p_76986_1_;
                    var201 = entityPlayerSP.prevRenderPitchHead + (entityPlayerSP.renderPitchHead - entityPlayerSP.prevRenderPitchHead) * p_76986_9_;
                } else
                    var201 = p_76986_1_.prevRotationPitch + (p_76986_1_.rotationPitch - p_76986_1_.prevRotationPitch) * p_76986_9_;
                ...
                if (this.field_177098_i) {
                    ...
                    //TODO: chams event
                    EntityRenderEvent packetEvent = new EntityRenderEvent(p_76986_1_);
                    Sulfur.getInstance().getEventBus().post(packetEvent);
                    this.renderModel(p_76986_1_, var17, var16, var14, var12, var201, 0.0625F);
                    Sulfur.getInstance().getEventBus().post(new EntityRenderEvent(false, p_76986_1_, var17, var16, var14, var12, var201));
                    if (var18) {
                        this.func_177091_f();
                    }
    ...
    protected boolean func_177092_a(EntityLivingBase p_177092_1_, float p_177092_2_, boolean p_177092_3_) {
        ...
        final HurtColor hurtColor = Sulfur.getInstance().getModuleManager().get(HurtColor.class);
        ...
        if (!var6 && !var7) {
            ...
            if (var7) {
                final float red = hurtColor.red.getValue().floatValue();
                final float green = hurtColor.green.getValue().floatValue();
                final float blue = hurtColor.blue.getValue().floatValue();
                final float alpha = hurtColor.alpha.getValue().floatValue();

                if (hurtColor.isToggled()) {
                    if (!hurtColor.booleanValue.getValue()) {
                        if (!hurtColor.rainbow.getValue()) {
                            this.field_177095_g.put(red / 255.0F);
                            this.field_177095_g.put(green / 255.0F);
                            this.field_177095_g.put(blue / 255.0F);
                            this.field_177095_g.put(alpha / 255.0F);

                            if (Config.isShaders()) {
                                Shaders.setEntityColor(red / 255.0F, green / 255.0F, blue / 255.0F, alpha / 255.0F);
                            }
                        } else {
                            ...
                            if (Config.isShaders()) {
                                Shaders.setEntityColor(color.getRed() / 255.0F, color.getGreen() / 255.0F, color.getBlue() / 255.0F, alpha / 255.0F);
                            }
                        }
                    } else {
                        final Color color = new Color(ColorUtil.getHealthColor(p_177092_1_));
    ...
    public void passSpecialRender(EntityLivingBase p_77033_1_, double p_77033_2_, double p_77033_4_, double p_77033_6_) {
        ...
        if (!Reflector.RenderLivingEvent_Specials_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, p_77033_1_, this, p_77033_2_, p_77033_4_, p_77033_6_)) {
            if (p_77033_1_ instanceof EntityPlayer) {
                RenderPlayerTagEvent renderPlayerTagEvent = new RenderPlayerTagEvent(p_77033_1_, p_77033_2_, p_77033_4_, p_77033_6_);
                Sulfur.getInstance().getEventBus().post(renderPlayerTagEvent);
                if (renderPlayerTagEvent.isCancelled()) {
                    return;
                }
            }
            if (this.canRenderName(p_77033_1_)) {
                ...
                if (var8 < (double) (var10 * var10)) {
                    ...
                    if (p_77033_1_.isSneaking()) {
                        ...
                        GlStateManager.func_179098_w();
                        GlStateManager.depthMask(true);
                        var13.drawString(var11, -var13.getStringWidth(var11) / 2.0F, 0, 553648127);
                        GlStateManager.enableLighting();
                        GlStateManager.disableBlend();
                        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                        GlStateManager.popMatrix();
