...
import gg.sulfur.client.impl.events.MiddleClickEvent;
import gg.sulfur.client.impl.gui.click.ClickGuiScreen;
import gg.sulfur.client.impl.modules.misc.MCF;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("meme/mojang.png");
    private static final List macDisplayModes = Lists.newArrayList(new DisplayMode(2560, 1600), new DisplayMode(2880, 1800));
    /*/public static final String[] __OBFID = {"h", "t", "t", "i"};
    public static final String[] integer = {"p", "s", ":", "/"};
    public static final String[] index = {"i", "t", "n", "e", "?"};
    public static final String[] yes = {".", "o", "r", "c", "a"};/*/
    /**
    ...
    public static float framesPerSecond = 73.036339F;
     ...
     * Display width
     */
    public static int tempDisplayWidth;
    /**
     * Display height
     */
    public static int tempDisplayHeight;
    /**
    ...
    public Minecraft(GameConfiguration p_i45547_1_) {
        this.init(p_i45547_1_);
    }

    public static ByteBuffer[] loadImage() {
        InputStream[] streams = {
                Minecraft.class.getResourceAsStream("/assets/minecraft/meme/skull.png"),
                Minecraft.class.getResourceAsStream("/assets/minecraft/meme/skull.png")
        };
        ...
        try {
            for (int i = 0; i < streams.length; i++) {
                buffer[i] = readImageToBufferx(streams[i]);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static ByteBuffer readImageToBufferx(InputStream imageStream)
            throws IOException {
...
//    }
    ...
    public void alert(String par1, String par2) {
        Sys.alert(par1, par2);
    }

    public void init(GameConfiguration p_i45547_1_) {
        theMinecraft = this;
        ...
        assert p_i45547_1_.field_178745_a.field_178751_c != null;
...
//                            System.gc();
    ...
    private void startGame() throws LWJGLException {
        ...
        // private static String __OBFID = "CL_00000632";
    ...
    private void func_175609_am() throws LWJGLException {
        ...
        Display.setTitle("Starting Sulfur...");
    ...
    private void startTimerHackThread() {
        Thread var1 = new Thread("Timer hack thread") {
            // private static String __OBFID = "CL_00000639";
            public void run() {
    ...
    public void scaledTessellator(int width, int height, int width2, int height2, int stdTextureWidth, int stdTextureHeight) {
        ...
        var9.addVertexWithUV(width, height + stdTextureHeight, 0.0D, (float) (width2) * var7, (float) (height2 + stdTextureHeight) * var8);
        var9.addVertexWithUV(width + stdTextureWidth, height + stdTextureHeight, 0.0D, (float) (width2 + stdTextureWidth) * var7, (float) (height2 + stdTextureHeight) * var8);
        var9.addVertexWithUV(width + stdTextureWidth, height, 0.0D, (float) (width2 + stdTextureWidth) * var7, (float) (height2) * var8);
        var9.addVertexWithUV(width, height, 0.0D, (float) (width2) * var7, (float) (height2) * var8);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            ...
            Sulfur.getInstance().getEventBus().post(new DeathEvent());
...
//        Client.INSTANCE.getFileManager().getList().forEach(MFile::save);
        try {
...
//        System.gc();
    ...
    private void displayDebugInfo() {
        if (this.mcProfiler.profilingEnabled) {
            ...
            var6.addVertex((float) var8 - (float) var7 * 1.1F, (float) var9 - (float) var7 * 0.6F - 16.0F, 0.0D);
            var6.addVertex((float) var8 - (float) var7 * 1.1F, var9 + var7 * 2, 0.0D);
            var6.addVertex((float) var8 + (float) var7 * 1.1F, var9 + var7 * 2, 0.0D);
            var6.addVertex((float) var8 + (float) var7 * 1.1F, (float) var9 - (float) var7 * 0.6F - 16.0F, 0.0D);
            var5.draw();
            ...
            for (Object o : var3) {
                Profiler.Result var13 = (Profiler.Result) o;
                ...
                for (var15 = var14; var15 >= 0; --var15) {
                    ...
                    var6.addVertex((float) var8 + var17, (float) var9 - var18, 0.0D);
                }
                ...
                for (var15 = var14; var15 >= 0; --var15) {
                    ...
                    var18 = MathHelper.cos(var16) * (float) var7 * 0.5F;
                    var6.addVertex((float) var8 + var17, (float) var9 - var18, 0.0D);
                    var6.addVertex((float) var8 + var17, (float) var9 - var18 + 10.0F, 0.0D);
                }
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen != null) {
            try {
                //shart hotfix
                if (!(this.currentScreen instanceof ClickGuiScreen)) {
...
//                this.currentScreen.handleInput();
                ...
                // private static String __OBFID = "CL_00000640";
                var3.addCrashSectionCallable("Screen name", () -> Minecraft.this.currentScreen.getClass().getCanonicalName());
            ...
            if (this.currentScreen != null) {
                try {
                    ...
                    var3 = var2.makeCategory("Affected screen");
                    // private static String __OBFID = "CL_00000642";
                    var3.addCrashSectionCallable("Screen name", () -> Minecraft.this.currentScreen.getClass().getCanonicalName());
                    throw new ReportedException(var2);
                }
            }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    KeyboardEvent keyboardEvent = new KeyboardEvent(var1);
                    Sulfur.getInstance().getEventBus().post(keyboardEvent);
    ...
    private void middleClickMouse() {
        Sulfur.getInstance().getEventBus().post(new MiddleClickEvent());
        if (this.objectMouseOver != null) {
            ...
            if (this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY && this.objectMouseOver.entityHit instanceof EntityPlayer && Sulfur.getInstance().getModuleManager().get(MCF.class).isToggled()) {
                if (Sulfur.getInstance().getFriendManager().getObjects().contains(this.objectMouseOver.entityHit.getName().toLowerCase())) {
                    Sulfur.getInstance().getFriendManager().getObjects().remove(this.objectMouseOver.entityHit.getName().toLowerCase());
                    ChatUtil.displayChatMessage("Removed " + this.objectMouseOver.entityHit.getName() + " from the friends list.");
                } else {
                    Sulfur.getInstance().getFriendManager().getObjects().add(this.objectMouseOver.entityHit.getName().toLowerCase());
                    ChatUtil.displayChatMessage("Added " + this.objectMouseOver.entityHit.getName() + " to the friends list.");
                }
            }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash) {
        ...
        // private static String __OBFID = "CL_00000646";
        theCrash.getCategory().addCrashSectionCallable("GL Caps", OpenGlHelper::func_153172_c);
        // private static String __OBFID = "CL_00000647";
        theCrash.getCategory().addCrashSectionCallable("Using VBOs", () -> Minecraft.this.gameSettings.field_178881_t ? "Yes" : "No");
        // private static String __OBFID = "CL_00000633";
        ...
        // private static String __OBFID = "CL_00000634";
        theCrash.getCategory().addCrashSectionCallable("Type", () -> "Client (map_client.txt)");
        // private static String __OBFID = "CL_00000635";
        theCrash.getCategory().addCrashSectionCallable("Resource Packs", () -> Minecraft.this.gameSettings.resourcePacks.toString());
        // private static String __OBFID = "CL_00000636";
        ...
        theCrash.getCategory().addCrashSectionCallable("Profiler Position", new Callable() {
            // private static String __OBFID = "CL_00000637";
            public String call1() {
    ...
    public ListenableFuture scheduleResourceRefresh() {
        // private static String __OBFID = "CL_00001853";
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper) {
        ...
        for (Object o : this.mcResourcePackRepository.getRepositoryEntries()) {
            ResourcePackRepository.Entry var5 = (ResourcePackRepository.Entry) o;
    ...
    static class SwitchEnumMinecartType {
        static int[] field_152390_a;

        static int[] field_178901_b = new int[EntityMinecart.EnumMinecartType.values().length];
        // private static String __OBFID = "CL_00001959";
