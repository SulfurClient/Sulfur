...
import gg.sulfur.client.impl.utils.player.UPlayer;
...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        int value = this.isPotionActive(Potion.digSpeed) ? 6 - (1 + this.getActivePotionEffect(Potion.digSpeed).getAmplifier()) : (this.isPotionActive(Potion.digSlowdown) ? 6 + (1 + this.getActivePotionEffect(Potion.digSlowdown).getAmplifier()) * 2 : 6);
        if (this instanceof EntityPlayerSP) {
            Animations animations = Sulfur.getInstance().getModuleManager().get(Animations.class);
            if (animations.isToggled()) {
                value += animations.slowdown.getValue().intValue();
            }
        }
        return value;
    }
     ...
     */
    protected void jump() {
        StrafeEvent event = new StrafeEvent(this.rotationYaw, 0.2f, this.func_175134_bD());
        ...
        if (this.isSprinting()) {
            float var1 = event.getYaw() * 0.017453292F;
            this.motionX -= MathHelper.sin(var1) * event.getForward();
            this.motionZ += MathHelper.cos(var1) * event.getForward();
        }
        ...
        if (this.isServerWorld()) {
            ...
            if (this.isInWater() && (!(this instanceof EntityPlayer) || !((EntityPlayer) this).capabilities.isFlying)) {
                ...
                if (var10 > 0.0F) {
                    ...
                    var6 += (this.getAIMoveSpeed() - var6) * var10 / 3.0F;
                }
    ...
    public boolean isOnSameTeam(EntityLivingBase p_142014_1_) {
        return p_142014_1_ != null && p_142014_1_.getTeam() != null && this.isOnTeam(p_142014_1_.getTeam());
    }
