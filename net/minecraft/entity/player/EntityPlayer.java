...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    public EntityPlayer(World worldIn, GameProfile p_i45324_2_) {
        ...
        this.setLocationAndAngles((double) var3.getX() + 0.5D, var3.getY() + 1, (double) var3.getZ() + 0.5D, 0.0F, 0.0F);
        ...
        if (itemStackIn.getItemUseAction() == EnumAction.EAT) {
            for (int var3 = 0; var3 < p_71010_2_; ++var3) {
                ...
                if (itemStackIn.getHasSubtypes()) {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var7.xCoord, var7.yCoord, var7.zCoord, var4.xCoord, var4.yCoord + 0.05D, var4.zCoord, Item.getIdFromItem(itemStackIn.getItem()), itemStackIn.getMetadata());
                } else {
                    this.worldObj.spawnParticle(EnumParticleTypes.ITEM_CRACK, var7.xCoord, var7.yCoord, var7.zCoord, var4.xCoord, var4.yCoord + 0.05D, var4.zCoord, Item.getIdFromItem(itemStackIn.getItem()));
                }
            }
    ...
    public void addToPlayerScore(Entity entityIn, int amount) {
        ...
        for (Object o : var3) {
            ScoreObjective var5 = (ScoreObjective) o;
    ...
    private Collection func_175137_e(Entity p_175137_1_) {
        ...
        if (var2 != null) {
            ...
            if (var3 >= 0 && var3 < IScoreObjectiveCriteria.field_178793_i.length) {
                ...
                for (Object o : this.getWorldScoreboard().func_96520_a(IScoreObjectiveCriteria.field_178793_i[var3])) {
                    ScoreObjective var5 = (ScoreObjective) o;
    ...
    public void dropOneItem(boolean p_71040_1_) {
        this.func_146097_a(this.inventory.decrStackSize(this.inventory.currentItem, p_71040_1_ && this.inventory.getCurrentItem() != null ? this.inventory.getCurrentItem().stackSize : 1), false, true);
    }

    /**
     * Args: itemstack, flag
     */
    public EntityItem dropPlayerItemWithRandomChoice(ItemStack itemStackIn, boolean b) {
    ...
    public float func_180471_a(Block p_180471_1_) {
        ...
        if (this.isPotionActive(Potion.digSlowdown)) {
            ...
            if (!Sulfur.getInstance().getModuleManager().get(Animations.class).isToggled()) {
        ...
        if (targetEntity.canAttackWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (var2 > 0.0F || var4 > 0.0F) {
                    ...
                    if (var14) {
                        if (var18 > 0) {
                            targetEntity.addVelocity((-MathHelper.sin(this.rotationYaw * (float) Math.PI / 180.0F) * (float) var18 * 0.5F), 0.1D, MathHelper.cos(this.rotationYaw * (float) Math.PI / 180.0F) * (float) var18 * 0.5F);
                            this.motionX *= 0.6D;
                            this.motionZ *= 0.6D;
    ...
    public void onKillEntity(EntityLivingBase entityLivingIn) {
        ...
        EntityList.EntityEggInfo var2 = (EntityList.EntityEggInfo) EntityList.entityEggs.get(EntityList.getEntityID(entityLivingIn));
    ...
    public float getEyeHeight() {
        ...
        /*/if (Sulfur.getInstance().getModuleManager().isEnabled(Speed.class)) {
            ...
            if (speed.getMode() != Speed.Mode.YPORT) {
                return var1;
            }

            if (!onGround && fallDistance < 0.05 && !(fallDistance > 0.05)) {
                var1 -= fallDistance;
                ChatUtil.displayChatMessage("shid");
            }
        }/*/
    ...
    public enum EnumChatVisibility {
        ...
        static {
            ...
            for (EnumChatVisibility var3 : var0) {
    ...
    public boolean isMoving() {
        return lastTickPosX != posX && lastTickPosZ != posZ;
    }
}
