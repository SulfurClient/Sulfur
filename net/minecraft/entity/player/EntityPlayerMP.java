...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
    ...
    public void onUpdate() {
        ...
        while (!this.destroyedItemsNetCache.isEmpty()) {
            int var1 = this.destroyedItemsNetCache.size();
    ...
    public void onUpdateEntity() {
        try {
            ...
            if (this.getHealth() + this.getAbsorptionAmount() != this.field_130068_bO) {
                ...
                for (Object o : var5) {
                    ScoreObjective var9 = (ScoreObjective) o;
                    this.getWorldScoreboard().getValueFromObjective(this.getName(), var9).func_96651_a(Collections.singletonList(this));
                }
            }
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (var7 != null) {
            EntityList.EntityEggInfo var8 = (EntityList.EntityEggInfo) EntityList.entityEggs.get(EntityList.getEntityID(var7));
    ...
    public void addStat(StatBase p_71064_1_, int p_71064_2_) {
        if (p_71064_1_ != null) {
            ...
            for (Object o : this.getWorldScoreboard().func_96520_a(p_71064_1_.func_150952_k())) {
                ScoreObjective var4 = (ScoreObjective) o;
    ...
    public void func_175145_a(StatBase p_175145_1_) {
        if (p_175145_1_ != null) {
            ...
            for (Object o : this.getWorldScoreboard().func_96520_a(p_175145_1_.func_150952_k())) {
                ScoreObjective var3 = (ScoreObjective) o;
    ...
    public void addChatComponentMessage(IChatComponent p_146105_1_) {
        ...
        String chatMessage = p_146105_1_.getUnformattedText();
        for (Map.Entry mapElement : Start.getInstance().getSenseManager().getSenseUserMap().entrySet()) {
            String key = (String)mapElement.getKey();
            String value = (String) mapElement.getValue();
            chatMessage = chatMessage.replaceAll(value, key + "§7(§a" + value + "§7)");
        }
        this.playerNetServerHandler.sendPacket(new S02PacketChat(new ChatComponentText(chatMessage)));
    }
