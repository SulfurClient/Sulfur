...
import gg.sulfur.client.impl.modules.exploit.ThunderDetect;
...
import gg.sulfur.client.impl.events.ServerPosLookEvent;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        //if (!Client.INSTANCE.getModuleManager().getByNameIgnoreSpaceCaseInsensitive("AutoRegister").isToggled()) Client.INSTANCE.getModuleManager().getByNameIgnoreSpaceCaseInsensitive("AutoRegister").toggle();
        ...
        Util.message("/updatesense", Channels.COMMANDS);
    }
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (var8 != null) {
            var8.serverPosX = packetIn.func_148997_d();
            var8.serverPosY = packetIn.func_148998_e();
            var8.serverPosZ = packetIn.func_148994_f();
            var8.rotationPitch = (float) (packetIn.func_149008_j() * 360) / 256.0F;
            var8.rotationYaw = (float) (packetIn.func_149006_k() * 360) / 256.0F;
            Entity[] var12 = var8.getParts();

            if (var12 != null) {
                int var10 = packetIn.func_149001_c() - var8.getEntityId();

                for (Entity entity : var12) {
                    entity.setEntityId(entity.getEntityId() + var10);
                }
            }

            var8.setEntityId(packetIn.func_149001_c());
            ...
            if (packetIn.func_149009_m() > 0) {
                ...
                var8.setVelocity((double) packetIn.func_149010_g() / 8000.0D, (double) packetIn.func_149004_h() / 8000.0D, (double) packetIn.func_148999_i() / 8000.0D);
            }
        }
    }
    ...
    public void handleSpawnGlobalEntity(S2CPacketSpawnGlobalEntity packetIn) {
        ...
        if (packetIn.func_149053_g() == 1) {
            ThunderDetect playerFinder = Sulfur.getInstance().getModuleManager().get(ThunderDetect.class);
            if (playerFinder != null && playerFinder.isToggled()) {
                ChatUtil.displayChatMessage("Located a player at: " + var2 + ", " + var4 + ", " + var6);
            }
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        ServerPosLookEvent serverPosLookEvent = new ServerPosLookEvent(packetIn.getX(), packetIn.getY(), packetIn.getZ(), packetIn.getYaw(),
                packetIn.getPitch(), packetIn.getYaw(), packetIn.getPitch());
        Sulfur.getInstance().getEventBus().post(serverPosLookEvent);

        double var3 = packetIn.getX();
        double var5 = packetIn.getY();
        double var7 = packetIn.getZ();
        float var9 = packetIn.getYaw();
        float var10 = packetIn.getPitch();
    ...
    public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
        ...
        for (S22PacketMultiBlockChange.BlockUpdateData var5 : var2) {
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        ...
        Sulfur.getInstance().getEventBus().post(packetEvent);
    ...
    public void handleCollectItem(S0DPacketCollectItem packetIn) {
        ...
        Entity var3 = this.clientWorldController.getEntityByID(packetIn.func_149353_d());
        ...
        if (var2 != null) {
            ...
            this.gameController.effectRenderer.addEffect(new EntityPickupFX(this.clientWorldController, var2, var3, 0.5F));
    ...
    public void handleChat(S02PacketChat packetIn) {
        ...
        if (packetIn.func_179841_c() == 2) {
            this.gameController.ingameGUI.func_175188_a(packetIn.getChatComponent(), false);
        } else {
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn) {
        ...
        if (var11 != null) {
            ...
            for (Entity entity : var11) {
                entity.setEntityId(entity.getEntityId() + var12);
            }
        }
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        Explosion var2 = new Explosion(this.gameController.theWorld, null, packetIn.func_149148_f(), packetIn.func_149143_g(), packetIn.func_149145_h(), packetIn.func_149146_i(), packetIn.func_149150_j());
...
//    }
    ...
    public void func_175100_a(S46PacketSetCompressionLevel p_175100_1_) {
        if (!this.netManager.isLocalChannel()) {
            this.netManager.setCompressionThreshold(p_175100_1_.func_179760_a());
        }
    }
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
        ...
        for (Object o : packetIn.func_179767_a()) {
            S38PacketPlayerListItem.AddPlayerData var3 = (S38PacketPlayerListItem.AddPlayerData) o;
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        ...
        if (url.startsWith("level://")) {
            String urlDir = url.substring("level://".length());
            File savesDir = new File(this.gameController.mcDataDir, "saves");
            File pack = new File(savesDir, urlDir);
            System.out.println(packetIn.getURL());
            if (pack.isFile()) {
                this.netManager.sendPacket(new C19PacketResourcePackStatus(hash, C19PacketResourcePackStatus.Action.ACCEPTED));
                Futures.addCallback(this.gameController.getResourcePackRepository().setResourcePackInstance(pack), new FutureCallback() {
            ...
            if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() == ServerData.ServerResourceMode.ENABLED) {
                ...
                this.gameController.addScheduledTask(() -> {
                    // private static final String __OBFID = "CL_00002622";
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo((result, id) -> {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        if (packetIn.getChannelName().equals("REGISTER")) {
            String contents = new String(packetIn.getBufferData().array(), Charsets.UTF_8);
            if (contents.contains("Lunar-Client")) {
                this.addToSendQueueNoEvent(new C17PacketCustomPayload("REGISTER", new PacketBuffer(Unpooled.wrappedBuffer("Lunar-Client".getBytes(Charsets.UTF_8)))));
            }
        }
        PacketThreadUtil.func_180031_a(packetIn, this, this.gameController);
        ...
        if (var2 != null) {
            if (!(var2 instanceof EntityLivingBase)) {
                ...
                for (Object o : packetIn.func_149441_d()) {
                    ...
                    if (var6 == null) {
                        var6 = var3.registerAttribute(new RangedAttribute(null, var5.func_151409_a(), 0.0D, 2.2250738585072014E-308D, Double.MAX_VALUE));
                    }

                    var6.setBaseValue(var5.func_151410_b());
                    var6.removeAllModifiers();

                    for (Object value : var5.func_151408_c()) {
                        AttributeModifier var8 = (AttributeModifier) value;
