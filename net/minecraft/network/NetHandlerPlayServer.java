...
public class NetHandlerPlayServer implements INetHandlerPlayServer, IUpdatePlayerListBox {
    ...
    public void kickPlayerFromServer(String reason) {
        ...
        this.netManager.sendPacket(new S40PacketDisconnect(var2), p_operationComplete_1_ -> NetHandlerPlayServer.this.netManager.closeChannel(var2), new GenericFutureListener[0]);
    ...
    public void processPlayer(C03PacketPlayer packetIn) {
        ...
        if (!this.playerEntity.playerConqueredTheEnd) {
            ...
            if (this.hasMoved) {
                ...
                AxisAlignedBB var49 = this.playerEntity.getEntityBoundingBox().expand(var41, var41, var41).addCoord(0.0D, -0.55D, 0.0D);
            ...
            case 6:
                ...
                if (var10 > 36.0D) {
                    ...
                    if (packetIn.func_180762_c() == C07PacketPlayerDigging.Action.START_DESTROY_BLOCK) {
                        if (!this.serverController.isBlockProtected() && var2.getWorldBorder().contains(var3)) {
    ...
    public void processPlayerBlockPlacement(C08PacketPlayerBlockPlacement packetIn) {
        ...
        if (packetIn.getPlacedBlockDirection() == 255) {
            ...
            if (this.hasMoved && this.playerEntity.getDistanceSq((double) var5.getX() + 0.5D, (double) var5.getY() + 0.5D, (double) var5.getZ() + 0.5D) < 64.0D && !this.serverController.isBlockProtected() && var2.getWorldBorder().contains(var5)) {
            ...
            if (this.playerEntity.func_175149_v()) {
                ...
                if (ItemStack.areItemStacksEqual(packetIn.getClickedItem(), var5)) {
                    ...
                    for (int var4 = 0; var4 < this.playerEntity.openContainer.inventorySlots.size(); ++var4) {
                        var6.add(this.playerEntity.openContainer.inventorySlots.get(var4).getStack());
                    }
    ...
    public void processTabComplete(C14PacketTabComplete packetIn) {
        ...
        for (Object o : this.serverController.func_180506_a(this.playerEntity, packetIn.getMessage(), packetIn.func_179709_b())) {
