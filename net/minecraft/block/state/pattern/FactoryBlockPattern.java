...
public class FactoryBlockPattern {
    ...
    public FactoryBlockPattern where(char p_177662_1_, java.util.function.Predicate p_177662_2_) {
        ...
        for(int var2 = 0; var2 < this.field_177665_b.size(); ++var2) {
            for(int var3 = 0; var3 < this.field_177663_d; ++var3) {
                for(int var4 = 0; var4 < this.field_177664_e; ++var4) {
                    var1[var2][var3][var4] = (Predicate)this.field_177666_c.get(((String[])((String[])this.field_177665_b.get(var2)))[var3].charAt(var4));
                }
            }
        }
