...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity) {
        BlockCollisionEvent event = new BlockCollisionEvent(this.getCollisionBoundingBox(worldIn, pos, state), state.getBlock(), pos.getX(), pos.getY(), pos.getZ());
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn) {
        float var4 = this.getBlockHardness();
    ...
    public MovingObjectPosition collisionRayTrace(World worldIn, BlockPos pos, Vec3 start, Vec3 end) {
        ...
        if (var5 != null) {
            if (var11 != null) {
                start.squareDistanceTo(var5);
                start.squareDistanceTo(var11);
            }
            var11 = var5;
        }
    ...
    public static void registerBlocks() {
        ...
        registerBlock(147, "light_weighted_pressure_plate", (new BlockPressurePlateWeighted(Material.iron, 15)).setHardness(0.5F).setStepSound(soundTypeWood).setUnlocalizedName("weightedPlate_light"));
        ...
        while (var13.hasNext()) {
            ...
            for (Object o : var14.getBlockState().getValidStates()) {
                IBlockState var22 = (IBlockState) o;
