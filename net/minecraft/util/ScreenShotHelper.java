...
public class ScreenShotHelper {
    ...
    public static IChatComponent saveScreenshot(File p_148259_0_, String p_148259_1_, int p_148259_2_, int p_148259_3_, Framebuffer p_148259_4_) {
        try {
            ...
            /*//BufferedImage finalVar1 = var7;
            new Thread(() -> {
                try {
                    BufferedImage finalVar = finalVar1;
                    ImageIO.write(finalVar, "png", var12);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }).start();/*/
            ChatComponentText var13 = new ChatComponentText(" \n§eScreenshot taken! §7(" + var12.getName() + ") \n ");
            var13.getChatStyle().setChatClickEvent(new ClickEvent(ClickEvent.Action.OPEN_FILE, var12.getAbsolutePath()));
            return new ChatComponentText(var13.getFormattedText());
        } catch (Exception var11) {
            logger.warn("Couldn\'t save screenshot", var11);
            return new ChatComponentText("\n §cFailed to take a screenshot. \n ");
        }
    }
