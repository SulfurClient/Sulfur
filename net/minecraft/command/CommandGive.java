...
public class CommandGive extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            ...
            Item var4 = getItemByText(args[1]);
            ...
            if (var11 && var7.stackSize <= 0) {
                ...
                var9 = var3.dropPlayerItemWithRandomChoice(var7, true);
            ...
            notifyOperators(sender, this, "commands.give.success", var7.getChatComponent(), var5, var3.getName());
        }
    }
